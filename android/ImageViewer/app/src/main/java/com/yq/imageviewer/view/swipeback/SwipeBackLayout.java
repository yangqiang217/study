...
public class SwipeBackLayout extends FrameLayout {
     ...
     * callback's
     * {@link ViewDragHelper.AbstractCallback#onEdgeTouched(int, int)}
     * and
     * {@link ViewDragHelper.AbstractCallback#onEdgeDragStarted(int, int)}
    ...
    private class ViewDragCallback extends ViewDragHelper.AbstractCallback {
