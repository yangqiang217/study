...
public class LoopViewPager extends ViewPager {
    ...
    private OnPageChangeListener onPageChangeListener = new OnPageChangeListener() {
        ...
        public void onPageSelected(int position) {
            ...
            Log("onPageSelected", "position: " + position + ", realpositon: " + realPosition);
...
//                Log("onPageScrolled", "position: " + position + ", realpositon: " + realPosition);
        ...
        public void onPageScrollStateChanged(int state) {
            if (mAdapter != null) {
                ...
                Log("onPageScrollStateChanged", "position: " + position + ", realpositon: " + realPosition);
