...
package com.yq.imageviewer.view.swipeback;
...
class ViewDragHelper {
    ...
    private final AbstractCallback mCallback;
     ...
     */
    public static ViewDragHelper create(ViewGroup forParent, AbstractCallback cb) {
     ...
     * @return a new ViewDragHelper instance
     */
    public static ViewDragHelper create(ViewGroup forParent, float sensitivity, AbstractCallback cb) {
     ...
     * @param forParent Parent view to monitor
     */
    private ViewDragHelper(Context context, ViewGroup forParent, AbstractCallback cb) {
        if (forParent == null) {
     ...
     * callback's
     * {@link AbstractCallback#onEdgeTouched(int, int)}
     * and
     * {@link AbstractCallback#onEdgeDragStarted(int, int)}
     ...
     * {@link AbstractCallback#tryCaptureView(View, int)}
     ...
     * {@link AbstractCallback#getOrderedChildIndex(int)}
     * .
     *
     * @param x X position to test in the parent's coordinate system
     * @param y Y position to test in the parent's coordinate system
